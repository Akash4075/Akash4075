...
class WelcomeScreen:
    def __init__(self, root):
        ...
        # ===== Language Selection =====
        self.lang_label = tk.Label(root, text="Select Language:", font=("Arial", 12), bg="#e0f7fa")
        ...
        try:
            ...
            self.logo_label_left = tk.Label(self.root, image=self.logo_photo_left, bg="#e0f7fa")
        ...
        try:
            ...
            self.logo_label_right = tk.Label(self.root, image=self.logo_photo_right, bg="#e0f7fa")
